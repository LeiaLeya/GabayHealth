...
class NotificationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bhc.notifications.index')->with('success', $successMessage);
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('bhc.notifications.index')->with('success', 'Notification deleted successfully!');
        } catch (\Exception $e) {
