...
class CalendarController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            return view('pages.calendars.index', compact('calendarEvents', 'currentMonth', 'groupedItems', 'availableMidwives', 'assignedDoctors'));
        } catch (\Exception $e) {
            \Log::error('Error fetching calendar data: ' . $e->getMessage());
            return view('pages.calendars.index', compact('calendarEvents', 'currentMonth', 'groupedItems', 'availableMidwives', 'assignedDoctors'))->with('error', 'Error loading calendar data. Please try again.');
        }
    }
