...
<div id="app">
    <div class="registration-wrapper">
        ...
        <div class="registration-header">
            ...
            <p>Complete your RHU registration</p>
        </div>
        ...
        <div class="stepper">
            <div class="step active" data-step="1">
                ...
                <div class="step-label">Your RHU</div>
            </div>
        ...
        <form method="POST" action="{{ route('register.rhu.google.submit') }}" enctype="multipart/form-data">
            ...
            <div class="step-panel active" id="step-1">
                <p class="step-heading">Tell us about your health unit</p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="rhuName" name="rhuName" class="form-control" placeholder="e.g. Rural Health Unit – Cainta" value="{{ old('rhuName') }}">
            ...
            <div class="step-panel" id="step-2">
                <p class="step-heading">Where is your health unit located?</p>
            ...
            <div class="step-panel" id="step-3">
                <p class="step-heading">Your Google account</p>
                ...
                <div class="google-badge">
                    ...
                    <a href="{{ route('google.redirect') }}">Change</a>
                </div>
...
<script>
let currentStep = {{ $errors->hasAny(['fullAddress', 'region', 'province', 'city']) ? 2 : ($errors->hasAny(['terms']) ? 3 : 1) }};
const totalSteps = 3;
...
function validateStep(step) {
    if (step === 1) {
        const rhuName = document.getElementById('rhuName').value.trim();
        if (!rhuName) {
            document.getElementById('rhuName').focus();
            document.getElementById('rhuName').style.borderColor = '#dc2626';
            return false;
        }
        document.getElementById('rhuName').style.borderColor = '';
    }
    if (step === 2) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function searchMapbox(query) {
        const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(query)}.json?access_token=${mapboxAccessToken}&country=PH&proximity=121.7740,12.8797&limit=8`;
