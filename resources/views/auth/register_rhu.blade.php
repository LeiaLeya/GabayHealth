        ...
        <form method="POST" action="{{ route('register.rhu.submit') }}" enctype="multipart/form-data">
            ...
            <div class="step-panel" id="step-3">
                ...
                <div class="form-group">
                    ...
                    <small>You will receive your credentials here after admin approval</small>
            ...
            <!-- File input lives at form level so it always submits regardless of which step is visible -->
...
<script>
// ── Wizard logic ──
let currentStep = {{ $errors->hasAny(['fullAddress', 'region', 'province', 'city']) ? 2 : ($errors->hasAny(['email', 'terms']) ? 3 : 1) }};
const totalSteps = 3;
...
function validateStep(step) {
    ...
    if (step === 2) {
        const address = document.getElementById('fullAddress').value.trim() ||
                        document.getElementById('addressSearch').value.trim();
...
// Initialize to errorStep on page load
