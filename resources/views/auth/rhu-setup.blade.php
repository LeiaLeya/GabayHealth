    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">Your RHU account has been approved. Please set a secure password to activate your account.</p>
                    ...
                    <form method="POST" action="{{ route('rhu.setup-password.store') }}">
                        @csrf
