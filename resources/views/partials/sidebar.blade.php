            ...
            if ($userRole === 'admin') {
                ...
                $navItems = [
                    ...
                    [
                        ...
                        'label' => 'Notifications',
                        'icon' => 'bi-bell',
                        'notification_group_badge' => true,
                        'routes' => ['rhu.notifications.index', 'rhu.notifications.create', 'rhu.notifications.sent'],
                        'children' => [
                            ['route' => 'rhu.notifications.index', 'label' => 'Inbox', 'icon' => 'bi-inbox', 'notification_inbox_badge' => true],
                            ['route' => 'rhu.notifications.create', 'label' => 'Send notification', 'icon' => 'bi-send'],
                            ['route' => 'rhu.notifications.sent', 'label' => 'Sent', 'icon' => 'bi-clock-history'],
                        ],
                    ],
                ...
                $navItems = [
                    ...
                    [
                        ...
                        'icon' => 'bi-bell',
                        'notification_group_badge' => true,
                        'routes' => ['bhc.notifications.index', 'bhc.notifications.create', 'bhc.notifications.sent'],
                        'children' => [
                            ['route' => 'bhc.notifications.index', 'label' => 'Inbox', 'icon' => 'bi-inbox', 'notification_inbox_badge' => true],
                            ['route' => 'bhc.notifications.create', 'label' => 'Send notification', 'icon' => 'bi-send'],
                            ['route' => 'bhc.notifications.sent', 'label' => 'Sent', 'icon' => 'bi-clock-history'],
                        ],
                    ],
