    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="content">
                ...
                <p>Great news! Your Barangay Health Center account on the GabayHealth platform has been <strong>restored</strong> by your Rural Health Unit administrator. Your account is now fully active.</p>
                ...
                <div class="info-box">
                    ...
                    <div class="info-row">
                        <span class="info-label">Restored by</span>
                ...
                <p>Your staff can now log in to GabayHealth using their existing credentials. All previously saved records, appointments, and reports are intact exactly as they were before the account was archived.</p>

                <div class="cta-box">
                    <p><strong>Ready to get started?</strong> Log in to the GabayHealth system using your existing username and password. If you have trouble accessing your account, please contact your Rural Health Unit at <a href="mailto:{{ $contactEmail }}" style="color:#1657c1;">{{ $contactEmail }}</a>.</p>
                </div>
