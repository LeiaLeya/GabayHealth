...
<head>
    ...
    <style>
        ...
        .header { background: #1657c1; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
        .content { background: white; padding: 30px; border-radius: 0 0 5px 5px; }
        .button { display: inline-block; background: #1657c1; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin: 20px 0; }
        .footer { text-align: center; font-size: 12px; color: #999; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; }
        .username-box { background: #f0f0f0; padding: 15px; border-left: 4px solid #1657c1; margin: 20px 0; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>GabayHealth Account Setup</h1>
        </div>
        
        <div class="content">
            <p>Dear <strong>{{ $rhuName }}</strong>,</p>
            
            <p>Your Rural Health Unit account has been <strong>approved</strong> by the System Administrator!</p>
            ...
            <p>Once you set your password, you'll have <strong>immediate access</strong> to the GabayHealth system.</p>
