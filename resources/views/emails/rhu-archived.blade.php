...
<head>
    ...
    <style>
        ...
        .alert-banner { background: #fef9c3; border-left: 4px solid #f59e0b; padding: 14px 20px; }
    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="content">
                ...
                <p>We are writing to inform you that your Rural Health Unit account on the GabayHealth platform has been <strong>archived</strong> by the system administrator.</p>
                ...
                <p>While your account is archived, your RHU will not appear in active lists and your staff will not be able to log in to the system. All your data — including barangay records, events, schedules, inventory, and reports — has been <strong>preserved</strong> and is not deleted.</p>

                <div class="notice-box">
                    <p><strong>Can this be reversed?</strong> Yes. Your account can be restored at any time by the GabayHealth system administrator. If you believe this was done in error or need your account reactivated, please contact the system administrator at <a href="mailto:{{ $contactEmail }}" style="color:#1657c1;">{{ $contactEmail }}</a>.</p>
                </div>
