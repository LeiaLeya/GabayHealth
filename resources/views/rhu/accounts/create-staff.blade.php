...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1" style="color:#1e293b;">Add Staff Member</h2>
            <p class="text-muted mb-0 small">Create a new staff account for this health center</p>
        </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            <div class="modal-type-badge">New Account</div>
            <div class="form-card-title">Staff Information</div>
        </div>
        <div class="form-card-body">
            ...
            <form action="{{ route('rhu.accounts.staff.store') }}" method="POST" id="createStaffForm">
                @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="tel" class="form-control rounded-3 @error('contact_number') is-invalid @enderror"
                                   id="contact_number" name="contact_number" value="{{ old('contact_number') }}" required placeholder="e.g. 09XX-XXX-XXXX">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-address-wrap">
                                <input type="text" class="form-control rounded-3 @error('address') is-invalid @enderror"
                                       id="address" name="address" value="{{ old('address') }}" placeholder="Search address or type manually…" autocomplete="off">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control rounded-3 @error('email') is-invalid @enderror"
                                   id="email" name="email" value="{{ old('email') }}" required placeholder="staff@example.com">
                            @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small fw-semibold">Password <span class="text-danger">*</span></label>
                            <input type="password" class="form-control rounded-3 @error('password') is-invalid @enderror"
                                   id="password" name="password" required placeholder="Min. 6 characters">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control rounded-3 @error('password_confirmation') is-invalid @enderror"
                                   id="password_confirmation" name="password_confirmation" required placeholder="Re-enter password">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-dark rounded-pill px-4">
                        <i class="bi bi-check2 me-1"></i>Create Staff Account
                    </button>
                </div>
            </form>
        </div>
...
document.getElementById('name').addEventListener('input', function() {
    ...
    if (!emailField.value || emailField.value.includes('@gabay-health.local')) {
        ...
        if (parts.length > 0) {
            ...
            emailField.value = first && last ? `${first}.${last}.${yr}@gabay-health.local` : '';
        }
    }
});
