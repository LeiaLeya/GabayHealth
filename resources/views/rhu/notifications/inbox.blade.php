...
<div class="container-fluid">
    ...
    <p class="text-muted mb-3">Messages and alerts you receive (for example, new barangay registrations).</p>

    @include('notifications._subnav', ['prefix' => 'rhu', 'active' => 'inbox'])
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            @forelse($inbox as $n)
                ...
                <div class="border-bottom pb-3 mb-3">
                    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2">
                        ...
                        <div>
                            @if($isUnread)
                                <form action="{{ route('rhu.notifications.read', $n['id']) }}" method="POST" class="d-inline">
                                    @csrf
            ...
            @empty
                <p class="text-muted text-center mb-0 py-4">Your inbox is empty. Incoming system messages will appear here.</p>
            @endforelse
        </div>
    </div>
</div>
