...
<div class="container-fluid">
    ...
    @include('notifications._subnav', ['prefix' => 'rhu', 'active' => 'create'])
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm border-0 bg-light">
                <div class="card-body">
                    ...
                    <a href="{{ route('rhu.notifications.sent') }}" class="btn btn-outline-primary btn-sm w-100">View sent history</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="fw-semibold">Send Health Alert to all residents of <strong>{{ session('user.name', 'RHU') }}</strong>?</p>
